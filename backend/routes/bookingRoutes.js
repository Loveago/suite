...
const { loadScopedProperty, requireAdminSession, requireMasterAdmin } = require('../middlewares/adminAuth');
...
router.delete('/:id', requireAdminSession, requireMasterAdmin, loadScopedProperty, deleteBooking);
