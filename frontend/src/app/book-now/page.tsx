                ...
                >
                  <div className="bg-dark-card border border-dark-border rounded-2xl p-6 sm:p-8 space-y-5 text-center">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className={labelCls}>Check-in <span className="text-gold normal-case tracking-normal">*</span></label>
                        <input
                          type="date"
                          value={checkIn}
                      ...
                      <div>
                        <label className={labelCls}>Check-out <span className="text-gold normal-case tracking-normal">*</span></label>
                        <input
                          type="date"
                          value={checkOut}
              ...
              {currentStep === 2 && (
                ...
                >
                  <div className="bg-dark-card border border-dark-border rounded-2xl p-6 sm:p-8 space-y-5 text-center">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className={labelCls}>First Name <span className="text-gold normal-case tracking-normal">*</span></label>
                        <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="John" className={inputCls} />
                      </div>
                      <div>
                        <label className={labelCls}>Last Name <span className="text-gold normal-case tracking-normal">*</span></label>
                        <input type="text" value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Doe" className={inputCls} />
                      </div>
                    </div>
                    <div>
                      <label className={labelCls}>Email Address <span className="text-gold normal-case tracking-normal">*</span></label>
                      <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="john@example.com" className={inputCls} />
                    </div>
                    <div>
                      <label className={labelCls}>Phone Number <span className="text-gold normal-case tracking-normal">*</span></label>
                      <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+1 (555) 000-0000" className={inputCls} />
                    </div>
                    <div>
                      <label className={labelCls}>Special Requests <span className="text-gray-600 normal-case tracking-normal text-xs">(Optional)</span></label>
                      <textarea
